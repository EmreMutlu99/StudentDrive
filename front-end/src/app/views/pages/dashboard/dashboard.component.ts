...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.customersChartOptions = this.getCustomersChartOptions(
      this.themeCssVariables
    );
    this.ordersChartOptions = this.getOrdersChartOptions(
      this.themeCssVariables
    );
    this.growthChartOptions = this.getGrowthChartOptions(
      this.themeCssVariables
    );
    ...
    this.cloudStorageChartOptions = this.getCloudStorageChartOptions(
      this.themeCssVariables
    );
  }
  ...
  getRevenueChartOptions(themeVariables: ThemeCssVariablesType) {
    return {
      series: [
        {
          ...
          data: [
            ...
            23.9, 19.2, 15.1, 15.0, 11.0, 9.2, 7.47, 11.6, 15.7, 13.9, 12.5,
            13.5, 15.0, 13.9, 13.2, 18.1, 20.6, 21.0, 25.3, 25.3, 20.9, 18.7,
            15.3, 14.5, 17.9, 15.9, 16.3, 14.1, 12.1, 14.8, 17.2, 17.7, 14.0,
            18.6, 18.4, 22.6, 25.0, 28.1, 28.0, 24.1, 24.2, 28.2, 26.2, 29.3,
            26.0, 23.9, 28.8, 25.1, 21.7, 23.0, 20.7, 29.7, 30.2, 32.5, 31.4,
            33.6, 30.0, 34.2, 36.9, 35.5, 34.7, 36.9,
          ],
        },
      ],
      chart: {
      ...
      colors: [
        ...
        themeVariables.danger,
        themeVariables.warning,
      ],
      grid: {
        padding: {
          bottom: -4,
